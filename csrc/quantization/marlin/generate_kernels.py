...
def generate_new_kernels():
    ...
    for quant_config in QUANT_CONFIGS:
        ...
        for a_type, c_type in itertools.product(a_types, c_types):
            ...
            # SM70 needs smaller thread_k due to shared memory constraints
            if SUPPORT_SM70 and (a_type, b_type, c_type) in sm_70_result_dict:
                for group_blocks, m_blocks in itertools.product(
                    ...
                    # SM70 large batch configs: (16, 512, 256), (16, 768, 256), (16, 1024, 256)
                    ...
                    # SM70 small batch configs: (16, 256, 128), (16, 384, 128), (16, 512, 128)
                    # These provide thread_k=16 for cases where K is not divisible by 64/128
                    if m_blocks <= 1:
                        for thread_k, thread_n, threads in [
                            (16, 256, 128),
    ...
    for result_dict_tmp in [result_dict, sm_75_result_dict, sm_70_result_dict]:
        for (a_type, b_type, c_type), config_list in result_dict_tmp.items():
            ...
            elif result_dict_tmp is sm_70_result_dict:
